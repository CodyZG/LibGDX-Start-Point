...
public class Gameplay_Screen implements Screen {
    ...
    //Camera how the camera views the world
    ...
    public void show() {
        ...
        shapeRenderer.setAutoShapeType(true); //???, unknown solution to a problem with drawing shapes
    }
    ...
    public void render(float delta) {
        ...
        //all drawings of shapes MUST be in between begin/end
        shapeRenderer.begin();
        shapeRenderer.setColor(1,1,0,1);
        shapeRenderer.circle(30,30,30);
        shapeRenderer.end();

        //all drawings of graphics MUST be in between begin/end
        spriteBatch.begin();
        spriteBatch.end();
    }
